  ...
  return (
    <form onSubmit={handleFormSubmit} className='flexStart form'>
      <div className='flexStart form_image-container'>
        ...
        {form.image && (
          <Image src={form.image} className="sm:pt-10 object-contain z-20" alt='Project poster' fill />
        ) }
      </div>
      ...
      <FormField title="Website URL" state={form.liveSiteUrl} placeholder="https://google.com" setState={value => handleStateChange('liveSiteUrl', value)} type='url' />
      <FormField title="GitHub URL" state={form.githubUrl} placeholder="https://github.com" setState={value => handleStateChange('githubUrl', value)} type='url' />
